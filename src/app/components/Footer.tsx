  ...
  return (
    ...
    >
      <div className="flex justify-between items-center gap-4">
        <p className="m-0 text-white text-sm font-medium tracking-wide">&copy; {currentYear} MrErenK</p>
        <div className="flex">
          <a 
          ...
          >
            {GitHubIcon && <FontAwesomeIcon icon={GitHubIcon} className="text-2xl transition-transform duration-300 hover:scale-110" />}
          </a>
        </div>
      </div>
    </footer>
